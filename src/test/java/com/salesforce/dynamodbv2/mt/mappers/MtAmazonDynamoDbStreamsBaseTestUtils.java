...
public class MtAmazonDynamoDbStreamsBaseTestUtils {
    ...
    static boolean equals(MtRecord expected, Record actual) {
        ...
        /*
         * This should happen temporarily while we do not properly process delete markers, so keys, and old/new image
         * are not properly mapped over on a deleted virtual table, as we lost the ability to do that mapping.
         */
