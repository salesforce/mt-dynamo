...
class MTAmazonDynamoDBChainTest {
    ...
    void test() {
        ...
        assertThat(logAggregator.messages, is(ImmutableList.of(
                ...
                "method=query(), table=ctx2.mt_sharedtablestatic_s_nolsi, filterExpression=#field1 = :value, names={#field1=hk}, values={:value={S: ctx2.MTAmazonDynamoDBTestRunner1.hashKeyValue,}}",
                ...
                "method=updateItem(), table=ctx1.mt_sharedtablestatic_s_nolsi, key={hk={S: ctx1.MTAmazonDynamoDBTestRunner1.hashKeyValue,}}",
                "method=getItem(), table=ctx1.mt_sharedtablestatic_s_nolsi, key={hk={S: ctx1.MTAmazonDynamoDBTestRunner1.hashKeyValue,}}",
                "method=updateItem(), table=ctx2.mt_sharedtablestatic_s_nolsi, key={hk={S: ctx2.MTAmazonDynamoDBTestRunner1.hashKeyValue,}}",
                "method=getItem(), table=ctx2.mt_sharedtablestatic_s_nolsi, key={hk={S: ctx2.MTAmazonDynamoDBTestRunner1.hashKeyValue,}}",
                ...
                "method=deleteItem(), table=ctx1.mt_sharedtablestatic_s_nolsi, key={hk={S: ctx1.MTAmazonDynamoDBTestRunner1.someValue1Updated,}}",
