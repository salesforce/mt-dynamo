...
public class RandomPartitioningTableMapping implements TableMapping {
    ...
    RandomPartitioningTableMapping(DynamoTableDescription virtualTable,
        ...
        itemMapper = new RandomPartitioningItemMapper(fieldMapper, tablePrimaryKeyFieldMappings, indexPrimaryKeyFieldMappings);
        recordMapper = new RandomPartitioningRecordMapper(mtContext, virtualTable.getTableName(), itemMapper, fieldMapper,
