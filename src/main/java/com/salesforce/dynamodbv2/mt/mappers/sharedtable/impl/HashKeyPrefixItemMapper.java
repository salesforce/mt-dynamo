 ...
 * @author msgroi
 */
class HashKeyPrefixItemMapper implements ItemMapper {

    private final FieldMapper fieldMapper;
    private final HashKeyPrefixTableMapping tableMapping;

    HashKeyPrefixItemMapper(HashKeyPrefixTableMapping tableMapping, FieldMapper fieldMapper) {
     ...
     */
    @Override
    public Map<String, AttributeValue> apply(Map<String, AttributeValue> unqualifiedItem) {
