...
* Fixed bug [Batch get that exceeds provisioned throughput or size limit results in `table metadata entry for 'SHARED.mt_sharedtablestatic_s_no_lsi' does not exist in SHARED._tablemetadata` error](https://github.com/salesforce/mt-dynamo/issues/386)
